...
public class DataTransferService extends IntentService {
    ...
    public static final String ACTION_SEND_FILE = "com.pritesh.ritintercom.SEND_FILE";
    public static final String ACTION_SEND_DATA = "com.pritesh.ritintercom.SEND_DATA";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_SEND_FILE)) {
            ...
            try {
                ...
                Utility.copyFile(is, stream, context);
