...
public class TinyDB {
     ...
     * @param defaultValue int value returned ifz key was not found
    ...
    public ArrayList<ChatData> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ChatData> objects =  new ArrayList<ChatData>();

    	for(String jObjString : objStrings){
    		ChatData value  = (ChatData) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<ChatData> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
